...
function ScheduleCreationPopup(container, calendars, usageStatistics) {
    ...
    domevent.on(container, 'keyup', this._onKeyUp, this);
}
 ...
 */
 ScheduleCreationPopup.prototype._onKeyUp = function(keyupEvent) {
...
ScheduleCreationPopup.prototype._onClickSaveSchedule = function(target) {
    ...
    var gubun = document.querySelector("input[name='gubun']:checked") ? document.querySelector("input[name='gubun']:checked").value : 0;
    ...
    if (!startDate && !endDate) {
        ...
        return false;
    } else if ( startDate.getDate() - endDate.getDate() != 0 ){
        alert("회의실 예약 가능한 일자는 최대 1일 입니다.")
        return false;
    }
...
ScheduleCreationPopup.prototype._makeEditModeData = function(viewModel) {
    ...
    var title, userName, place, gubun, isPrivate, location, startDate, endDate, isAllDay, state, place_0_checked, place_1_checked, gubun_0_checked, gubun_1_checked;
    ...
    place_0_checked = schedule.place == 0;
    place_1_checked = schedule.place == 1;
    gubun_0_checked = schedule.gubun == 0;
    gubun_1_checked = schedule.gubun == 1;
    ...
    return {
        ...
        title: title,
        userName: userName,
        place_0_checked: place_0_checked,
        place_1_checked: place_1_checked,
        place: place,
        gubun_0_checked: gubun_0_checked,
        gubun_1_checked: gubun_1_checked,
        gubun: gubun,
        isPrivate: isPrivate,
        location: location,
        isAllDay: isAllDay,
...
ScheduleCreationPopup.prototype._onClickUpdateSchedule = function(form) {
    var changes = common.getScheduleChanges(
        this._schedule,
        ['calendarId', 'title', 'userName', 'place', 'gubun', 'location', 'start', 'end', 'isAllDay', 'state'],
        {
